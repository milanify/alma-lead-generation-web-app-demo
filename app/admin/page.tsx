  ...
  return (
    <div className="space-y-8 font-sans w-full max-w-[1000px]">
      ...
      <div className="flex space-x-4 mb-2">
        ...
        <div className="relative">
          <button 
            ...
            className="flex items-center space-x-3 px-5 py-3 border border-gray-200 rounded-xl text-[15px] font-semibold text-gray-500 bg-white hover:bg-gray-50 transition-colors w-40 justify-between"
          >
      ...
      <div className="border border-gray-200 rounded-2xl bg-white shadow-sm overflow-visible">
                ...
                <tr key={lead.id} className="hover:bg-gray-50/50 transition-colors group">
                  ...
                  <td className="px-8 py-6 whitespace-nowrap">
                    <button 
                      ...
                      className={`font-bold transition-colors ${lead.status === 'PENDING' ? 'text-gray-900 hover:text-gray-600' : 'text-gray-500 hover:text-gray-800'}`}
        ...
        {/* Pagination */}
        <div className="bg-white px-8 py-5 flex justify-end items-center space-x-6 border-t border-gray-100 rounded-b-2xl relative">
          ...
          <div className="flex items-center space-x-2 text-sm text-gray-500 font-medium relative">
            ...
            <div className="relative">
              ...
              {isPaginationDropdownOpen && (
                <div className="absolute bottom-full left-0 mb-1 w-20 bg-white border border-gray-200 rounded-lg shadow-lg z-50 py-1">
                  {[5, 10, 'All'].map((opt) => (
                    <button
                      key={opt}
